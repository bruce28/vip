...
$sql='SELECT * FROM `Delivery`'
         ...
         . ' INNER JOIN Source ON Origin.Source_source_id=Source.source_id WHERE QtyPickedUP>0 ORDER BY date, delivery_id ';
...
INNER JOIN Source ON Origin.Source_source_id=Source.source_id WHERE (Trans_Category_Category_id='66' OR Trans_Category_Category_id='93') AND Site_site_id='";
   ...
   //$rek["batch_date"];
   echo '<tr><td>'.$rek_weee["batch_id"].'</td><td>'.$batch_date_id.'</td>'; 
