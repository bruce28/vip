...
<tr><td>Test</td><td>Barcode</td><td>Item</td><td>Brand</td><td>Item Type</td><td>PAT</td><td>Functionality</td><td>Cleaning</td>
<td>Visual state</td><td>Reinstallation</td><td>Formatted</td><td>Ready</td><td>Date</td></tr>
<?php
		  ...
		  echo '<td>'.test_string($rek["Visual_id_visual"]).'</td>';
           echo '<td>'.test_string($rek["Reinstallation_id_reinst"]).'</td>';
			 ...
			 echo '<td>'.test_string($rek["Ready"]).'</td>';
			  echo '<td>'.$rek[12].'</td>';
              echo '<td>'.$rek["id_defect"].'</td>';
              echo '<td>'.$rek["state"].'</td>';
	 echo '</tr>';
     //}
