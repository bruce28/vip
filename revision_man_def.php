...
{
    redirect("revision_man_def.php",0);
...
<tr><td>Category Description</td><td>Category</td><td>Priority Reference</td><td>Manifest Definition</td></tr>
<?php
   ...
   //echo '<tr><td>'.$rek["Name_sub"].'</td>'; 
	// echo '<td>'.$rek["kind"].'</td>';
	 ...
	 echo '<td>'.$rek["name_cat"].'</td>';
	   echo '<td>'.$rek["id"].'.</td>';
            echo '<td> <form action="revision_man_def.php" method="POST">';
...
echo '</td><td><input style="padding:10px;margin:10px" type="text" placeholder="Define Priority Flag.." name="batch_date" value="'.htmlentities($weight).'">';
...
echo "<input style='padding:10px;margin:10px' type='submit' name='Submit' value='Priority' align='right'>";
