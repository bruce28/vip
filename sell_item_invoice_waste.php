...
<form action="invoice_print_waste.php?ref_sell=<?php echo $ref_sell ?>  " method="POST">
...
<form onsubmit="return ini()" action="invoice_print_waste.php?ref_sell=<?php echo $ref_sell; ?>"  method="POST">
