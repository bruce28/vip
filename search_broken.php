     ...
     //    . ' INNER JOIN Cleaning ON Cleaning.id_clean=Test.Cleaning_id_clean '
      //   . ' INNER JOIN Cleaning ON Cleaning.id_clean=Test.Cleaning_id_clean '
        // . ' INNER JOIN Defect ON Test.id_test=Defect.Test_id_test'
         . ' INNER JOIN Item ON Barcode.Item_id_item=Item.id_item WHERE Test.Ready=0 Order by Test.date';
...
<tr><td>Test</td><td>Barcode</td><td>Item</td><td>Brand</td><td>Item type</td><td>PAT</td><td>Functionality</td><td>Cleaning</td><td>Visual state</td><td>Reinstallation</td><td>Formatted</td><td>Ready</td><td>Date Tested
    </td></tr>
<?php
...
<div id="buttons_out"> 
 ...
 <p class="submit">  
       <a onclick="defaultStatus" href="index.php"> <button class="submit">Return</button> </a>
       <!--
