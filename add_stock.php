...
if($message==14)
    $message="A Barcode connected with a new weight class. Everything is fine. Item added in stock.";
...
if($message==6)
    $message="Added a new item type, with a new active weight category. Barcode stocked in";
...
<div id="all">
    ...
    <div id="form_stock" style="font: xx-large; font-variant: simplified; font-family: sans-serif; font-size:  inherit; "> <p>Stocking Manager Module</p>
</BR>
<div margin="10px">
...
if($_GET['ref']==1)
{
   ...
   $site_location=$_GET["site_location"]; 
    ...
    $result=mysql_query($sql_reference) or die(mysql_error());
...
<?php if($IS_WEIGHT_SET!=2 AND $show_site==1) ://onclick="return validate();" ?>    
