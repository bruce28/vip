...
<tr>
 <td colspan="3">Ileak</td><td  style="background-color: whitesmoke" ></td><td><input  type="text" placeholder="Meter Output" value="<?php if(isset($_GET['meter_out'])) echo $_GET['meter_out']; ?>" name="meter2" style="padding:9px;  
    border: solid 1px #E5E5E5;  
    outline: 0;  
    font: normal 13px/100% Verdana, Tahoma, sans-serif;  
    width: 100%;  
...
<?php if($_SESSION['class_2']!=1) : ?>
<tr>
 <td colspan="3">Ileak</td><td  style="background-color: whitesmoke" ></td><td><input  type="text" placeholder="Meter Output" value="<?php if(isset($_GET['meter_out'])) echo $_GET['meter_out']; ?>" name="meter3" style="padding:9px;  
    border: solid 1px #E5E5E5;  
    outline: 0;  
    font: normal 13px/100% Verdana, Tahoma, sans-serif;  
    width: 100%;  
