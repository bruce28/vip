...
//we will set pat_control first

if($v_bar_exist==0 
)
{
  $PAT_CONTROL=1;  
  if(isset($_POST['pat_class']))
  $_SESSION['pat_class']=$_POST['pat_class'];  
...
//// this modul/part happens only while wher item name was not in database. This creates a fresh weight
 ...
 // echo "MESSG_EX".$MESSG_EX;
    ...
    $pat_class=$_SESSION['pat_class'];
    $barcode=swap_hash($barcode);
  $url="add_stock.php?test=".$barcode.'&MESSG=6';
