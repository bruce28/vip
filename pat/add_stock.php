...
<div margin="10px">
 ...
 <!--<a href="../" onclick="popitup('../checkup.php')">Check List</a>-->
...
<tr><td>Barcode</td><td>Item</td><td>Brand</td><td>Model Number</td><?php if($PAT_CONTROL==1)echo '<td><B>PAT Test</B></td>' ?></tr>
<tr>
...
<td>
<?php if($PAT_CONTROL==1) :?>    
</br>
<input type="radio" name="pat_class" value="1" <?php if($PAT_CLASS==1)echo 'checked';if(!isset($_GET['pat_class'])) ?>  /> CLASS 1
<input type="radio" name="pat_class" value="2" <?php if($PAT_CLASS==2)echo 'checked';if(!isset($_GET['pat_class'])) ?>  /> CLASS 2
<input type="radio" name="pat_class" value="0" <?php if($PAT_CLASS==0)echo 'checked';if(!isset($_GET['pat_class']))?> /> Not Applicable
</td>
<?php endif ?>
...
echo "<table width='50%'>";
 ...
 $url="add_barcode.php?test_stock=1&V_BARCODE=";
 $url.=$V_BARCODE;
 echo $PAT_CLASS=$_GET['pat_class'];


 if($PAT_CLASS==1)
 {
     $url.='&pat_class='.$PAT_CLASS;
     redirect($url,0);
 }
 if($PAT_CLASS==2)
 {  
